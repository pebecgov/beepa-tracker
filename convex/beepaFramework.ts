...
export const BEEPA_REFORMS: ReformTemplate[] = [
  ...
  },
  {
    ...
    activities: [
      { ref: "7.1", name: "Functional official website exists, hosted on an approved government domain (.gov.ng)", weight: 0.10 },
      { ref: "7.2", name: "Clear mandate, leadership information, organogram, and contact details publicly available on the website", weight: 0.10 },
      { ref: "7.3", name: "Comprehensive list of services provided by the MDA publicly available on the website", weight: 0.10 },
      { ref: "7.4", name: "Service Level Agreements (SLAs) for all applicable services publicly accessible, including timelines, requirements, fees, and processes", weight: 0.20 },
      { ref: "7.5", name: "Online application and tracking functionality available for all applicable services", weight: 0.15 },
      { ref: "7.6", name: "Service-specific FAQs published and regularly updated", weight: 0.15 },
      { ref: "7.7", name: "Responsive customer service emails publicly displayed and functional", weight: 0.05 },
      { ref: "7.8", name: "Accessible and responsive customer service phone numbers", weight: 0.05 },
      { ref: "7.9", name: "ReportGov must be linked in the top right of the website", weight: 0.10 },
    ],
  },
];
